    ...
    pub fn get_available_events(
        ...
        match self {
            Normal => vec![
                ...
                MoveRequestUp(EventKeyBinding::new(
                    vec![key_bindings.main_menu.move_request_up],
                    "Move request up",
                    None,
                )),
                MoveRequestDown(EventKeyBinding::new(
            ...
            DisplayingCookies => vec![
                GoBackToMainMenu(EventKeyBinding::new(
            ...
            CreatingNewCollection => vec![
                GoBackToMainMenu(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.cancel],
                    "Cancel",
                    Some("Cancel"),
                )),
                CreateNewCollection(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.confirm],
                    "Confirm",
                    Some("Confirm"),
                )),
                CreatingCollectionDeleteCharBackward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_backward],
                    "Delete char backward",
                    Some("Delete"),
                )),
                CreatingCollectionDeleteCharForward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_forward],
                    "Delete char forward",
                    Some("Backspace"),
                )),
                CreatingCollectionMoveCursorLeft(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.move_cursor_left],
                    "Move cursor left",
                    Some("Left"),
                )),
                CreatingCollectionMoveCursorRight(EventKeyBinding::new(
                    vec![
                        key_bindings
                            .generic
                            .text_inputs
            ...
            CreatingNewRequest => vec![
                ...
                CreatingRequestDeleteCharBackward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_backward],
                    "Delete char backward",
                    Some("Delete"),
                )),
                CreatingRequestDeleteCharForward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_forward],
                    "Delete char forward",
                    Some("Backspace"),
                )),
                CreatingRequestMoveCursorLeft(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.move_cursor_left],
                    "Move cursor left",
                    Some("Left"),
                )),
                CreatingRequestMoveCursorRight(EventKeyBinding::new(
                    vec![
                        key_bindings
                            .generic
                            .text_inputs
                ...
                CreatingRequestSelectCollectionUp(EventKeyBinding::new(
                    vec![key_bindings.generic.navigation.alt_move_cursor_up],
                    "Collection selection up",
                    Some("Up"),
                )),
                CreatingRequestSelectCollectionDown(EventKeyBinding::new(
                    vec![key_bindings.generic.navigation.alt_move_cursor_down],
                    "Collection selection down",
                    Some("Down"),
                )),
            ...
            RenamingCollection => vec![
                ...
                RenamingCollectionDeleteCharBackward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_backward],
                    "Delete char backward",
                    Some("Delete"),
                )),
                RenamingCollectionDeleteCharForward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_forward],
                    "Delete char forward",
                    Some("Backspace"),
                )),
                RenamingCollectionMoveCursorLeft(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.move_cursor_left],
                    "Move cursor left",
                    Some("Left"),
                )),
                RenamingCollectionMoveCursorRight(EventKeyBinding::new(
                    vec![
                        key_bindings
                            .generic
                            .text_inputs
            ...
            RenamingRequest => vec![
                ...
                RenamingRequestDeleteCharBackward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_backward],
                    "Delete char backward",
                    Some("Delete"),
                )),
                RenamingRequestDeleteCharForward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_forward],
                    "Delete char forward",
                    Some("Backspace"),
                )),
                RenamingRequestMoveCursorLeft(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.move_cursor_left],
                    "Move cursor left",
                    Some("Left"),
                )),
                RenamingRequestMoveCursorRight(EventKeyBinding::new(
                    vec![
                        key_bindings
                            .generic
                            .text_inputs
            ...
            EditingRequestUrl => vec![
                ...
                EditingRequestUrlDeleteCharBackward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_backward],
                    "Delete char backward",
                    Some("Delete"),
                )),
                EditingRequestUrlDeleteCharForward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_forward],
                    "Delete char forward",
                    Some("Backspace"),
                )),
                EditingRequestUrlMoveCursorLeft(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.move_cursor_left],
                    "Move cursor left",
                    Some("Left"),
                )),
                EditingRequestUrlMoveCursorRight(EventKeyBinding::new(
                    vec![
                        key_bindings
                            .generic
                            .text_inputs
            ...
            EditingRequestParam => vec![
                ...
                EditingRequestQueryParamDeleteCharBackward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_backward],
                    "Delete char backward",
                    Some("Delete"),
                )),
                EditingRequestQueryParamDeleteCharForward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_forward],
                    "Delete char forward",
                    Some("Backspace"),
                )),
                EditingRequestQueryParamMoveCursorLeft(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.move_cursor_left],
                    "Move cursor left",
                    Some("Left"),
                )),
                EditingRequestQueryParamMoveCursorRight(EventKeyBinding::new(
                    vec![
                        key_bindings
                            .generic
                            .text_inputs
            ...
            EditingRequestAuthUsername => vec![
                ...
                ModifyRequestAuthUsername(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.confirm],
                    "Confirm",
                    Some("Confirm"),
                )),
                EditingRequestAuthUsernameDeleteCharBackward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_backward],
                    "Delete char backward",
                    Some("Delete"),
                )),
                EditingRequestAuthUsernameDeleteCharForward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_forward],
                    "Delete char forward",
                    Some("Backspace"),
                )),
                EditingRequestAuthUsernameMoveCursorLeft(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.move_cursor_left],
                    "Move cursor left",
                    Some("Left"),
                )),
                EditingRequestAuthUsernameMoveCursorRight(EventKeyBinding::new(
                    vec![
                        key_bindings
                            .generic
                            .text_inputs
                ...
                EditingRequestAuthUsernameCharInput(EventKeyBinding::new(
                    vec![],
                    "Char input",
                    None,
                )),
            ...
            EditingRequestAuthPassword => vec![
                ...
                ModifyRequestAuthPassword(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.confirm],
                    "Confirm",
                    Some("Confirm"),
                )),
                EditingRequestAuthPasswordDeleteCharBackward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_backward],
                    "Delete char backward",
                    Some("Delete"),
                )),
                EditingRequestAuthPasswordDeleteCharForward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_forward],
                    "Delete char forward",
                    Some("Backspace"),
                )),
                EditingRequestAuthPasswordMoveCursorLeft(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.move_cursor_left],
                    "Move cursor left",
                    Some("Left"),
                )),
                EditingRequestAuthPasswordMoveCursorRight(EventKeyBinding::new(
                    vec![
                        key_bindings
                            .generic
                            .text_inputs
                ...
                EditingRequestAuthPasswordCharInput(EventKeyBinding::new(
                    vec![],
                    "Char input",
                    None,
                )),
            ...
            EditingRequestAuthBearerToken => vec![
                ...
                EditingRequestAuthBearerTokenDeleteCharBackward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_backward],
                    "Delete char backward",
                    Some("Delete"),
                )),
                EditingRequestAuthBearerTokenDeleteCharForward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_forward],
                    "Delete char forward",
                    Some("Backspace"),
                )),
                EditingRequestAuthBearerTokenMoveCursorLeft(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.move_cursor_left],
                    "Move cursor left",
                    Some("Left"),
                )),
                EditingRequestAuthBearerTokenMoveCursorRight(EventKeyBinding::new(
                    vec![
                        key_bindings
                            .generic
                            .text_inputs
                ...
                EditingRequestAuthBearerTokenCharInput(EventKeyBinding::new(
                    vec![],
                    "Char input",
                    None,
                )),
            ...
            EditingRequestHeader => vec![
                ...
                EditingRequestHeaderDeleteCharBackward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_backward],
                    "Delete char backward",
                    Some("Delete"),
                )),
                EditingRequestHeaderDeleteCharForward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_forward],
                    "Delete char forward",
                    Some("Backspace"),
                )),
                EditingRequestHeaderMoveCursorLeft(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.move_cursor_left],
                    "Move cursor left",
                    Some("Left"),
                )),
                EditingRequestHeaderMoveCursorRight(EventKeyBinding::new(
                    vec![
                        key_bindings
                            .generic
                            .text_inputs
            ...
            EditingRequestBodyTable => vec![
                ...
                EditingRequestBodyTableDeleteCharBackward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_backward],
                    "Delete char backward",
                    Some("Delete"),
                )),
                EditingRequestBodyTableDeleteCharForward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_forward],
                    "Delete char forward",
                    Some("Backspace"),
                )),
                EditingRequestBodyTableMoveCursorLeft(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.move_cursor_left],
                    "Move cursor left",
                    Some("Left"),
                )),
                EditingRequestBodyTableMoveCursorRight(EventKeyBinding::new(
                    vec![
                        key_bindings
                            .generic
                            .text_inputs
            ...
            EditingRequestBodyFile => vec![
                ...
                EditingRequestBodyFileDeleteCharBackward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_backward],
                    "Delete char backward",
                    Some("Delete"),
                )),
                EditingRequestBodyFileDeleteCharForward(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.delete_forward],
                    "Delete char forward",
                    Some("Backspace"),
                )),
                EditingRequestBodyFileMoveCursorLeft(EventKeyBinding::new(
                    vec![key_bindings.generic.text_inputs.text_input.move_cursor_left],
                    "Move cursor left",
                    Some("Left"),
                )),
                EditingRequestBodyFileMoveCursorRight(EventKeyBinding::new(
                    vec![
                        key_bindings
                            .generic
                            .text_inputs
            ...
            EditingRequestBodyString => match key_bindings.generic.text_inputs.text_area_mode {
                TextAreaMode::VimEmulation => vec![
                    EditingRequestBodyStringVimInput(EventKeyBinding::new(
                        vec![],
                        "Vim input",
                        None,
                    )),
                ...
                TextAreaMode::Custom(text_area_key_bindings) => vec![
                    ...
                    EditingRequestBodyStringSaveAndQuit(EventKeyBinding::new(
                        vec![text_area_key_bindings.save_and_quit],
                        "Save and quit",
                        Some("Save"),
                    )),
                    EditingRequestBodyStringCopy(EventKeyBinding::new(
                        vec![text_area_key_bindings.copy],
                        "Copy",
                        Some("Copy"),
                    )),
                    EditingRequestBodyStringPaste(EventKeyBinding::new(
                        vec![text_area_key_bindings.paste],
                        "Paste",
                        Some("Paste"),
                    )),
                    EditingRequestBodyStringUndo(EventKeyBinding::new(
                        vec![text_area_key_bindings.undo],
                        "Undo",
                        Some("Undo"),
                    )),
                    EditingRequestBodyStringRedo(EventKeyBinding::new(
                        vec![text_area_key_bindings.redo],
                        "Redo",
                        Some("Redo"),
                    )),
                    EditingRequestBodyStringNewLine(EventKeyBinding::new(
                        vec![text_area_key_bindings.new_line],
                        "New line",
                        None,
                    )),
                    EditingRequestBodyStringIndent(EventKeyBinding::new(
                        vec![text_area_key_bindings.indent],
                        "Indent",
                        None,
                    )),
                    EditingRequestBodyStringDeleteCharBackward(EventKeyBinding::new(
                        vec![text_area_key_bindings.delete_backward],
                        "Delete char backward",
                        None,
                    )),
                    EditingRequestBodyStringDeleteCharForward(EventKeyBinding::new(
                        vec![text_area_key_bindings.delete_forward],
                        "Delete char forward",
                        None,
                    )),
                    EditingRequestBodyStringSkipWordLeft(EventKeyBinding::new(
                        vec![text_area_key_bindings.skip_word_left],
                        "Skip word left",
                        None,
                    )),
                    EditingRequestBodyStringSkipWordRight(EventKeyBinding::new(
                        vec![text_area_key_bindings.skip_word_right],
                        "Skip word right",
                        None,
                    )),
                    EditingRequestBodyStringMoveCursorUp(EventKeyBinding::new(
                        vec![text_area_key_bindings.move_cursor_up],
                        "Up",
                        Some("Up"),
                    )),
                    EditingRequestBodyStringMoveCursorDown(EventKeyBinding::new(
                        vec![text_area_key_bindings.move_cursor_down],
                        "Down",
                        Some("Down"),
                    )),
                    EditingRequestBodyStringMoveCursorLeft(EventKeyBinding::new(
                        vec![text_area_key_bindings.move_cursor_left],
                        "Left",
                        Some("Left"),
                    )),
                    EditingRequestBodyStringMoveCursorRight(EventKeyBinding::new(
                        vec![text_area_key_bindings.move_cursor_right],
                        "Right",
                        Some("Right"),
                    )),
                    EditingRequestBodyStringCharInput(EventKeyBinding::new(
                        vec![],
                        "Char input",
                        None,
                    )),
            ...
            EditingPreRequestScript => match key_bindings.generic.text_inputs.text_area_mode {
                TextAreaMode::VimEmulation => vec![
                    EditingPreRequestScriptVimInput(EventKeyBinding::new(
                        vec![],
                        "Vim input",
                        None,
                    )),
                    Documentation(EventKeyBinding::new(
                        vec![*crate::app::app_states::EMPTY_KEY],
                        "Vim key-bindings",
                        Some("Vim-like key bindings"),
                    )),
                    Documentation(EventKeyBinding::new(
                ...
                TextAreaMode::Custom(text_area_key_bindings) => vec![
                    ...
                    EditingPreRequestScriptSaveAndQuit(EventKeyBinding::new(
                        vec![text_area_key_bindings.save_and_quit],
                        "Save and quit",
                        Some("Save"),
                    )),
                    EditingPreRequestScriptCopy(EventKeyBinding::new(
                        vec![text_area_key_bindings.copy],
                        "Copy",
                        Some("Copy"),
                    )),
                    EditingPreRequestScriptPaste(EventKeyBinding::new(
                        vec![text_area_key_bindings.paste],
                        "Paste",
                        Some("Paste"),
                    )),
                    EditingPreRequestScriptUndo(EventKeyBinding::new(
                        vec![text_area_key_bindings.undo],
                        "Undo",
                        Some("Undo"),
                    )),
                    EditingPreRequestScriptRedo(EventKeyBinding::new(
                        vec![text_area_key_bindings.redo],
                        "Redo",
                        Some("Redo"),
                    )),
                    EditingPreRequestScriptNewLine(EventKeyBinding::new(
                        vec![text_area_key_bindings.new_line],
                        "New line",
                        None,
                    )),
                    EditingPreRequestScriptIndent(EventKeyBinding::new(
                        vec![text_area_key_bindings.indent],
                        "Indent",
                        None,
                    )),
                    EditingPreRequestScriptDeleteCharBackward(EventKeyBinding::new(
                        vec![text_area_key_bindings.delete_backward],
                        "Delete char backward",
                        None,
                    )),
                    EditingPreRequestScriptDeleteCharForward(EventKeyBinding::new(
                        vec![text_area_key_bindings.delete_forward],
                        "Delete char forward",
                        None,
                    )),
                    EditingPreRequestScriptSkipWordLeft(EventKeyBinding::new(
                        vec![text_area_key_bindings.skip_word_left],
                        "Skip word left",
                        None,
                    )),
                    EditingPreRequestScriptSkipWordRight(EventKeyBinding::new(
                        vec![text_area_key_bindings.skip_word_right],
                        "Skip word right",
                        None,
                    )),
                    EditingPreRequestScriptMoveCursorUp(EventKeyBinding::new(
                        vec![text_area_key_bindings.move_cursor_up],
                        "Up",
                        Some("Up"),
                    )),
                    EditingPreRequestScriptMoveCursorDown(EventKeyBinding::new(
                        vec![text_area_key_bindings.move_cursor_down],
                        "Down",
                        Some("Down"),
                    )),
                    EditingPreRequestScriptMoveCursorLeft(EventKeyBinding::new(
                        vec![text_area_key_bindings.move_cursor_left],
                        "Left",
                        Some("Left"),
                    )),
                    EditingPreRequestScriptMoveCursorRight(EventKeyBinding::new(
                        vec![text_area_key_bindings.move_cursor_right],
                        "Right",
                        Some("Right"),
                    )),
                    EditingPreRequestScriptCharInput(EventKeyBinding::new(
                        vec![],
                        "Char input",
                        None,
                    )),
            ...
            EditingPostRequestScript => match key_bindings.generic.text_inputs.text_area_mode {
                TextAreaMode::VimEmulation => vec![
                    EditingPostRequestScriptVimInput(EventKeyBinding::new(
                        vec![],
                        "Vim input",
                        None,
                    )),
                ...
                TextAreaMode::Custom(text_area_key_bindings) => vec![
                    ...
                    EditingPostRequestScriptSaveAndQuit(EventKeyBinding::new(
                        vec![text_area_key_bindings.save_and_quit],
                        "Save and quit",
                        Some("Save"),
                    )),
                    EditingPostRequestScriptCopy(EventKeyBinding::new(
                        vec![text_area_key_bindings.copy],
                        "Copy",
                        Some("Copy"),
                    )),
                    EditingPostRequestScriptPaste(EventKeyBinding::new(
                        vec![text_area_key_bindings.paste],
                        "Paste",
                        Some("Paste"),
                    )),
                    EditingPostRequestScriptUndo(EventKeyBinding::new(
                        vec![text_area_key_bindings.undo],
                        "Undo",
                        Some("Undo"),
                    )),
                    EditingPostRequestScriptRedo(EventKeyBinding::new(
                        vec![text_area_key_bindings.redo],
                        "Redo",
                        Some("Redo"),
                    )),
                    EditingPostRequestScriptNewLine(EventKeyBinding::new(
                        vec![text_area_key_bindings.new_line],
                        "New line",
                        None,
                    )),
                    EditingPostRequestScriptIndent(EventKeyBinding::new(
                        vec![text_area_key_bindings.indent],
                        "Indent",
                        None,
                    )),
                    EditingPostRequestScriptDeleteCharBackward(EventKeyBinding::new(
                        vec![text_area_key_bindings.delete_backward],
                        "Delete char backward",
                        None,
                    )),
                    EditingPostRequestScriptDeleteCharForward(EventKeyBinding::new(
                        vec![text_area_key_bindings.delete_forward],
                        "Delete char forward",
                        None,
                    )),
                    EditingPostRequestScriptSkipWordLeft(EventKeyBinding::new(
                        vec![text_area_key_bindings.skip_word_left],
                        "Skip word left",
                        None,
                    )),
                    EditingPostRequestScriptSkipWordRight(EventKeyBinding::new(
                        vec![text_area_key_bindings.skip_word_right],
                        "Skip word right",
                        None,
                    )),
                    EditingPostRequestScriptMoveCursorUp(EventKeyBinding::new(
                        vec![text_area_key_bindings.move_cursor_up],
                        "Up",
                        Some("Up"),
                    )),
                    EditingPostRequestScriptMoveCursorDown(EventKeyBinding::new(
                        vec![text_area_key_bindings.move_cursor_down],
                        "Down",
                        Some("Down"),
                    )),
                    EditingPostRequestScriptMoveCursorLeft(EventKeyBinding::new(
                        vec![text_area_key_bindings.move_cursor_left],
                        "Left",
                        Some("Left"),
                    )),
                    EditingPostRequestScriptMoveCursorRight(EventKeyBinding::new(
                        vec![text_area_key_bindings.move_cursor_right],
                        "Right",
                        Some("Right"),
                    )),
                    EditingPostRequestScriptCharInput(EventKeyBinding::new(
                        vec![],
                        "Char input",
                        None,
                    )),
            ...
            EditingRequestSettings => vec![
                ...
                RequestSettingsToggleSetting(EventKeyBinding::new(
                    vec![
                        key_bindings.generic.navigation.move_cursor_left,
                        key_bindings.generic.navigation.move_cursor_right,
                    ],
                    "Toggle setting",
                    Some("Toggle"),
                )),
...
impl App<'_> {
    pub fn update_current_available_events(&mut self) {
        *AVAILABLE_EVENTS.write() = self
            .state
            .get_available_events(self.request_view, self.request_param_tab);
    }
    ...
    pub fn get_state_line(&self) -> Line {
        match self.state {
            ...
            | CreatingNewRequest
            | DisplayingCookies
            | EditingCookies => Line::from(self.state.to_string().white().on_dark_gray()),
