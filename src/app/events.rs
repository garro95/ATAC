    ...
    async fn handle_key(&mut self, key: KeyCombination) -> bool {
        ...
        match matching_event {
            ...
            Some(event) => match event {
                ...
                CreatingCollectionDeleteCharBackward(_) => {
                    self.new_collection_input.delete_char_forward()
                }
                CreatingCollectionDeleteCharForward(_) => {
                    self.new_collection_input.delete_char_backward()
                }
                ...
                CreatingRequestDeleteCharForward(_) => {
                    self.new_request_popup.text_input.delete_char_backward()
                }
                CreatingRequestMoveCursorLeft(_) => {
                    self.new_request_popup.text_input.move_cursor_left()
                }
                CreatingRequestMoveCursorRight(_) => {
                    self.new_request_popup.text_input.move_cursor_right()
                }
                CreatingRequestSelectCollectionUp(_) => {
                ...
                RenamingCollectionDeleteCharBackward(_) => {
                    self.rename_collection_input.delete_char_forward()
                }
                RenamingCollectionDeleteCharForward(_) => {
                    self.rename_collection_input.delete_char_backward()
                }
                RenamingCollectionMoveCursorLeft(_) => {
                    self.rename_collection_input.move_cursor_left()
                }
                ...
                RenamingRequestDeleteCharForward(_) => {
                    self.rename_request_input.delete_char_backward()
                }
                ...
                EditingRequestQueryParamDeleteCharBackward(_) => self
                    ...
                    .delete_char_forward(),
                EditingRequestQueryParamDeleteCharForward(_) => self
                    .query_params_table
                    .selection_text_input
                    .delete_char_backward(),
                EditingRequestQueryParamMoveCursorLeft(_) => self
                    .query_params_table
                    .selection_text_input
                    .move_cursor_left(),
                EditingRequestQueryParamMoveCursorRight(_) => self
                    .query_params_table
                    .selection_text_input
                    .move_cursor_right(),
                ...
                EditingRequestAuthUsernameDeleteCharBackward(_) => {
                    self.auth_basic_username_text_input.delete_char_forward()
                }
                EditingRequestAuthUsernameDeleteCharForward(_) => {
                    self.auth_basic_username_text_input.delete_char_backward()
                }
                EditingRequestAuthUsernameMoveCursorLeft(_) => {
                    self.auth_basic_username_text_input.move_cursor_left()
                }
                ...
                EditingRequestAuthPasswordDeleteCharForward(_) => {
                    self.auth_basic_password_text_input.delete_char_backward()
                }
                EditingRequestAuthPasswordMoveCursorLeft(_) => {
                    self.auth_basic_password_text_input.move_cursor_left()
                }
                ...
                EditingRequestAuthBearerTokenDeleteCharForward(_) => {
                    self.auth_bearer_token_text_input.delete_char_backward()
                }
                EditingRequestAuthBearerTokenMoveCursorLeft(_) => {
                    self.auth_bearer_token_text_input.move_cursor_left()
                }
                ...
                EditingRequestHeaderDeleteCharBackward(_) => self
                    .headers_table
                    .selection_text_input
                    .delete_char_forward(),
                EditingRequestHeaderDeleteCharForward(_) => self
                    .headers_table
                    .selection_text_input
                    .delete_char_backward(),
                EditingRequestHeaderMoveCursorLeft(_) => {
                    self.headers_table.selection_text_input.move_cursor_left()
                }
                ...
                EditingRequestBodyTableDeleteCharBackward(_) => self
                    .body_form_table
                    .selection_text_input
                    .delete_char_forward(),
                EditingRequestBodyTableDeleteCharForward(_) => self
                    .body_form_table
                    .selection_text_input
                    .delete_char_backward(),
                EditingRequestBodyTableMoveCursorLeft(_) => {
                    self.body_form_table.selection_text_input.move_cursor_left()
                }
                EditingRequestBodyTableMoveCursorRight(_) => self
                    .body_form_table
                    .selection_text_input
                    .move_cursor_right(),
                ...
                EditingRequestBodyFileDeleteCharForward(_) => {
                    self.body_file_text_input.delete_char_backward()
                }
                EditingRequestBodyFileMoveCursorLeft(_) => {
                    self.body_file_text_input.move_cursor_left()
                }
                ...
                EditingRequestBodyStringPaste(_) => {
                    self.body_text_area.paste();
                }
                EditingRequestBodyStringUndo(_) => {
                    self.body_text_area.undo();
                }
                EditingRequestBodyStringRedo(_) => {
                ...
                EditingRequestBodyStringDeleteCharBackward(_) => {
                    self.body_text_area.delete_next_char();
                }
                EditingRequestBodyStringDeleteCharForward(_) => {
                    self.body_text_area.delete_char();
                }
                EditingRequestBodyStringSkipWordLeft(_) => {
                    self.body_text_area.move_cursor(CursorMove::WordBack)
                }
                EditingRequestBodyStringSkipWordRight(_) => {
                    self.body_text_area.move_cursor(CursorMove::WordForward)
                }
                EditingRequestBodyStringMoveCursorUp(_) => {
                    self.body_text_area.move_cursor(CursorMove::Up)
                }
                EditingRequestBodyStringMoveCursorDown(_) => {
                    self.body_text_area.move_cursor(CursorMove::Bottom)
                }
                EditingRequestBodyStringMoveCursorLeft(_) => {
                    self.body_text_area.move_cursor(CursorMove::Back)
                }
                ...
                EditingPreRequestScriptVimInput(_) => match self
                    .script_console
                    .vim_emulation
                    .transition(key, &mut self.script_console.pre_request_text_area)
                {
                    VimTransition::Mode(mode) if self.script_console.vim_emulation.mode != mode => {
                        self.script_console
                            .pre_request_text_area
                            .set_block(mode.block());
                        self.script_console
                            .pre_request_text_area
                            .set_cursor_style(mode.cursor_style());
                ...
                EditingPreRequestScriptPaste(_) => {
                    self.script_console.pre_request_text_area.paste();
                }
                EditingPreRequestScriptUndo(_) => {
                    self.script_console.pre_request_text_area.undo();
                }
                EditingPreRequestScriptRedo(_) => {
                    self.script_console.pre_request_text_area.redo();
                }
                EditingPreRequestScriptNewLine(_) => {
                    self.script_console.pre_request_text_area.insert_newline()
                }
                ...
                EditingPreRequestScriptDeleteCharBackward(_) => {
                    self.script_console.pre_request_text_area.delete_next_char();
                }
                EditingPreRequestScriptDeleteCharForward(_) => {
                    self.script_console.pre_request_text_area.delete_char();
                }
                EditingPreRequestScriptSkipWordLeft(_) => self
                    .script_console
                    .pre_request_text_area
                    .move_cursor(CursorMove::WordBack),
                EditingPreRequestScriptSkipWordRight(_) => self
                    .script_console
                    .pre_request_text_area
                    .move_cursor(CursorMove::WordForward),
                EditingPreRequestScriptMoveCursorUp(_) => self
                    .script_console
                    .pre_request_text_area
                    .move_cursor(CursorMove::Up),
                EditingPreRequestScriptMoveCursorDown(_) => self
                    .script_console
                    .pre_request_text_area
                    .move_cursor(CursorMove::Bottom),
                EditingPreRequestScriptMoveCursorLeft(_) => self
                    .script_console
                    .pre_request_text_area
                    .move_cursor(CursorMove::Back),
                EditingPreRequestScriptMoveCursorRight(_) => self
                    .script_console
                    .pre_request_text_area
                ...
                EditingPostRequestScriptVimInput(_) => match self
                    .script_console
                    .vim_emulation
                    .transition(key, &mut self.script_console.post_request_text_area)
                {
                    VimTransition::Mode(mode) if self.script_console.vim_emulation.mode != mode => {
                        self.script_console
                ...
                EditingPostRequestScriptCopy(_) => {
                    self.script_console.post_request_text_area.copy()
                }
                EditingPostRequestScriptPaste(_) => {
                    self.script_console.post_request_text_area.paste();
                }
                EditingPostRequestScriptUndo(_) => {
                    self.script_console.post_request_text_area.undo();
                }
                EditingPostRequestScriptRedo(_) => {
                    self.script_console.post_request_text_area.redo();
                }
                EditingPostRequestScriptNewLine(_) => {
                    self.script_console.post_request_text_area.insert_newline()
                }
                ...
                EditingPostRequestScriptDeleteCharBackward(_) => {
                    self.script_console
                        .post_request_text_area
                        .delete_next_char();
                }
                EditingPostRequestScriptDeleteCharForward(_) => {
                    self.script_console.post_request_text_area.delete_char();
                }
                EditingPostRequestScriptSkipWordLeft(_) => self
                    .script_console
                    .post_request_text_area
                    .move_cursor(CursorMove::WordBack),
                EditingPostRequestScriptSkipWordRight(_) => self
                    .script_console
                    .post_request_text_area
                    .move_cursor(CursorMove::WordForward),
                EditingPostRequestScriptMoveCursorUp(_) => self
                    .script_console
                    .post_request_text_area
                    .move_cursor(CursorMove::Up),
                EditingPostRequestScriptMoveCursorDown(_) => self
                    .script_console
                    .post_request_text_area
                    .move_cursor(CursorMove::Bottom),
                EditingPostRequestScriptMoveCursorLeft(_) => self
                    .script_console
                    .post_request_text_area
                    .move_cursor(CursorMove::Back),
                EditingPostRequestScriptMoveCursorRight(_) => self
                    .script_console
                    .post_request_text_area
                    .move_cursor(CursorMove::Forward),
...
impl AppEvent {
    pub fn get_event_key_bindings(&self) -> &EventKeyBinding {
        match self {
            ...
            | Documentation(event_key_bindings) => event_key_bindings,
        }
    }
}
